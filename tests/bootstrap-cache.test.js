...
assert(config.includes('purple-gestao-v230'), 'auth/config.js deve apontar para cache v230');
...
assert(index.includes('app.js?v=224'), 'index.html deve apontar para app v224');
...
assert(index.includes('modules/lesson-plans.js?v=24'), 'index.html deve carregar Lesson Plans antes do app');
assert(sw.includes('modules/lesson-plans.js?v=24'), 'service worker deve versionar Lesson Plans');
