-- Permite persistir a Biblioteca/planos/capas/recursos do Lesson Plans em app_records.
-- Sem isto, o upload de capa/PDF funciona, mas o botão "Salvar capa/PDF" é bloqueado por RLS.
...
alter policy records_update on public.app_records using (
  ...
  public.has_sector_access(sector) and (
    kind <> 'lesson_plans_workspace' or public.is_direction() or public.has_permission('lesson_plans.edit')
  )
);
